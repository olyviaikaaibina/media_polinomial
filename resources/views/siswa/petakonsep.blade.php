...
@section('content')
    <div class="container-fluid px-0">
        ...
        <!-- Judul -->
        <h2 class="mb-4 text-center" style="font-family:'Playfair Display', serif; color:#2f5d3a; font-weight:800;">
            Peta Konsep
        </h2>

        <!-- Gambar -->
        <div class="text-center mb-4">
            <img src="{{ asset('img/petakonsep.png') }}" alt="Peta Konsep Polinomial" class="img-fluid"
                style="border-radius:14px; border:1px solid rgba(0,0,0,0.08);">
        </div>

        <!-- Tombol -->
        <div class="d-flex justify-content-center gap-3 mb-3">
            <a href="{{ asset('img/petakonsep.png') }}" download class="btn"
                style="background:#8F9F76; color:white; border-radius:999px; padding:10px 22px; font-weight:600;">
                Unduh Gambar
            </a>

            <a href="{{ asset('img/petakonsep.png') }}" target="_blank" class="btn"
